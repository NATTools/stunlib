...
uint8_t test_addr_ipv6[16] = {0x20, 0x1, 0x4, 0x70, 0xdc, 0x88, 0x1, 0x22, 0x21, 0x26, 0x18, 0xff, 0xfe, 0x92, 0x6d, 0x53};
...
static void SimBindSuccessResp(bool IPv6, bool success)
{
    StunMessage m;
    memset(&m, 0, sizeof(m));
